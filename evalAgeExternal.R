...
full_data_base_true <- data.frame(base_eval_mat_true,
                             outcome_base = outcome_base)
full_data_ema_true <- data.frame(ema_eval_mat,
                            outcome_base = outcome_base)
...
print(eavg_plots)
# 
export(auc_plots, file = "./output/cprd_models_on_sidiap_auc.png")
export(eavg_plots, file = "./output/cprd_models_on_sidiap_eavg.png")
