...
eavg_ema_plot <- full_data_ema %>%
  ...
  heatmaply::heatmaply(dendrogram = "none",
                       ...
                       plot_method = "plotly",
                       colorbar_len=1,
                       colors = viridis(n = 512,  option = "magma", direction = -1),
                       # cellnote = TRUE,
                       draw_cellnote = TRUE,
                       digits = 5L,
                       cellnote_textposition = "middle center",
...
print(eavg_plots)
# 
export(auc_plots, file = "./output/cprd_models_on_ipci_auc_.png")
export(eavg_plots, file = "./output/cprd_models_on_ipci_eavg_.png")
